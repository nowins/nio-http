...
public class BodyParserFactory {
    ...
    public static BodyParser createUrlEncodedParser(long contentLength, long maxBodySize) {
        return new UrlEncodedParser(contentLength, maxBodySize);
    }
    ...
    public static BodyParser createMultipartParser(String boundary, long sizeThreshold, long maxBodySize) {
        return new MultipartParser(boundary, sizeThreshold, maxBodySize);
    }
    ...
    public static BodyParser createChunkedBodyParser(long sizeThreshold, long maxBodySize) {
        return new ChunkedBodyParser(sizeThreshold, maxBodySize);
    }
